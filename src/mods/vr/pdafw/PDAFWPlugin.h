...
#define SHADING_RATE_SHIFT 3
	...
	// REFramework: bound at RUNTIME via GetProcAddress (no import lib). Signatures of the DLL exports:
	using InitDeviceFn = D3D12RendererAPI* (__stdcall*)(DeviceParams params);
	using InitFrameWarpFn = EyeFrameBuffers (__stdcall*)(FrameWarpInitParams params);
	using EvaluateFrameWarpFn = void (__stdcall*)(FrameWarpEvaluateParams& params);
}
